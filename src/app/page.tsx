          ...
          <div className="bg-gradient-to-r from-emerald-900/20 to-transparent border border-emerald-500/10 rounded-3xl p-8 lg:p-12 flex flex-col md:flex-row items-center justify-between gap-10">
            ...
            <div className="max-w-xl">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
                Precision agriculture requires precision context.
              </h2>{" "}
              <p className="text-muted-foreground text-lg leading-relaxed">
                {" "}
                Diseases don't exist in a vacuum. By analyzing the exact live
                weather conditions at your farm's location, the AI provides
                highly accurate, context-aware risk profiles and treatment
                timing.{" "}
              </p>{" "}
            </div>{" "}
            {/* Weather Card Mockup */}{" "}
            <div className="w-full md:w-[320px] bg-card border border-border rounded-2xl p-6 shadow-2xl relative overflow-hidden">
              {" "}
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-foreground mb-6">
              We don't just identify a disease.
            </h2>{" "}
            <p className="text-xl text-muted-foreground font-light max-w-2xl mx-auto">
              We understand the exact conditions around your crop to provide
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
              ...
              {[
                ...
                <div
                  key={item}
                  className="p-4 bg-accent border border-border rounded-xl text-center text-xs font-semibold text-muted-foreground tracking-wider"
                >
                  {" "}
                  {item}{" "}
                </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              {["DIAGNOSIS", "RISK", "TIMING", "RECOMMENDATION"].map((item) => (
                <div
                  key={item}
                  className="p-4 bg-accent border border-border rounded-xl text-center text-sm font-bold text-foreground"
                >
                  {" "}
                  {item}{" "}
                </div>
      ...
      <section className="py-24 border-t border-border">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <div className="pl-6 border-l-2 border-border space-y-8 relative">
              {" "}
              <div className="relative">
                {" "}
                <div className="absolute -left-[35px] top-1 w-4 h-4 rounded-full bg-red-500 border-4 border-background" />{" "}
              ...
              <div className="relative">
                {" "}
                <div className="absolute -left-[35px] top-1 w-4 h-4 rounded-full bg-amber-500 border-4 border-background" />{" "}
                <p className="text-xs text-muted-foreground font-medium mb-1">
                  SCAN 02
                </p>{" "}
                <p className="text-foreground font-semibold">
              ...
              <div className="relative">
                {" "}
                <div className="absolute -left-[35px] top-1 w-4 h-4 rounded-full bg-emerald-500 border-4 border-background" />{" "}
                <p className="text-xs text-muted-foreground font-medium mb-1">
                  SCAN 03
                </p>{" "}
                <p className="text-foreground font-semibold">Healthy</p>{" "}
              </div>{" "}
            </div>{" "}
          </div>{" "}
          {/* Weather visual */}{" "}
          <div>
            ...
            <div className="space-y-4">
              {" "}
              <div className="p-5 rounded-2xl bg-accent border border-border flex items-center justify-between opacity-50">
                {" "}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
                See disease activity beyond your field.
              </h2>{" "}
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                {" "}
                View anonymized regional data to understand local outbreak
                patterns. When a disease starts spreading in your district,
                you'll know before it reaches your crop.{" "}
              </p>{" "}
            ...
            <div className="relative aspect-video rounded-3xl overflow-hidden border border-border bg-card">
              ...
              <div
                className="absolute top-1/2 left-1/2 w-3 h-3 bg-red-500 rounded-full animate-ping opacity-75"
                style={{ animationDelay: "1s" }}
              ></div>{" "}
              <div className="absolute top-1/2 left-1/2 w-3 h-3 bg-red-500 rounded-full"></div>{" "}
              <div className="absolute bottom-4 left-4 right-4 p-4 rounded-xl bg-background/80 backdrop-blur-md border border-border flex justify-between items-center">
                {" "}
                <span className="text-sm font-semibold text-foreground">
                  Regional Analysis
                </span>{" "}
                <span className="text-xs text-red-400 font-bold px-2 py-1 rounded bg-red-500/20">
                  Elevated Outbreak Risk
                </span>{" "}
              </div>{" "}
            </div>{" "}
          </div>{" "}
      ...
      <section className="py-24 border-y border-border">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-muted-foreground font-light mb-12">
            {" "}
            Ask questions, log farm data, and hear recommendations in Hindi or
            English. Built so farmers don't need technical knowledge to use
            advanced AI.{" "}
          </p>{" "}
          <div className="flex items-center justify-center gap-4 text-sm font-bold text-muted-foreground tracking-widest uppercase">
            {" "}
            <span>English</span>{" "}
            <div className="w-1.5 h-1.5 rounded-full bg-white/20" />{" "}
            <span className="text-primary">हिन्दी</span>{" "}
          </div>{" "}
        </div>{" "}
      </section>{" "}
      {/* BOTTOM CTA */}{" "}
